...
%
{\color{red} insert function, and contour plot}
%
...
%
Rastrigin is highly multimodal, and as such presents a challenge for identifying convergence due to the many similar modes.
%
The multimodality of this problem increases the variablility of the EI criterion, and thus represents a a moderately difficult optimization problem. 
%
It should be noted that by increasing the size of the search domain, either by increasing the bounds of the search square and/or increasing the dimension of the domain would make this example a considerably more difficult optimization problem, as well as, less intuitive for tuning parameters.

%
{\color{red}insert convergence chart and best Z figure}
%
