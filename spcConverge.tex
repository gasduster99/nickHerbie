...
%
The solution shown here is the lowest function evaluation observed in 500 iterations of this algorithm, corresponding to $f(\bm{x})\approx26696$ at $\bm{x}\approx[0, 6195, 12988, 3160, 1190, 3163]$.
%
{\color{red} literature consistent value citation?}
...
%
For poorly tuned surrogate modeling strategies the EWMA convergence chart may only identify that the algorithm has reached a point of diminishing returns; for correctly tuned surrogate modeling strategies this point may often correspond with the realization of an optimal solution. 
%
