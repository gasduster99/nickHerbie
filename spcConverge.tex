...
%
Black-box derivative-free optimization is an important problem with a
...
pump-and-treat problem {\color{red}cite}, discussed in more detail in Section
...
the expensive computer simulation using a statistical surrogate model.
%
...
\cite{santnerBook}{\color{red}cite}.
...
In fact, this use ignores the nature of the EI criterion as a random variable, and oversimplifies the stochastic nature of convergence in this setting.
%
...
\caption{
%
Three ELAI seires plotted alongside an example convergence threshold value shown as 
a dashed line at -10. {\color{red}fix ELAI y label}
}
\label{introFig}
\end{figure}
%
...
%
The right panel (the Rastigin test function) 
...
use a threshold test over-simplifies the dynamics of convergence. 
%
