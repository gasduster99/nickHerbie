...
\caption{ Prior to the observation of $Y_i$, all availiable values are used to define a forcasted value for $Z_i$ using Eq. (\ref{ewmaStat}). $S_\lambda$ is subsisquently calculated upon observation of $Y_i$ and $Z_i$. Here $\hat\lambda$ is shown by the vertical the dashed line. }
\label{bestL}
\end{wrapfigure}
%
%
