...
$)}}$, and we describe the covariance structure, among the multiple dimensions of the $z(\bm{x})$, through specification of a covariance function, $K(\bm{x}, \bm{x}')$.
%
...
\end{equation} 
%
Specifying conjugate priors for $\bm{\beta}$ and $\sigma^2$ yields a straightforward Gibbs sampling {\color{red}cite} inferential setting with the exception of the covariance structure parameters requiring Metropolis-Hastings MCMC sampling {\color{red}cite}.
