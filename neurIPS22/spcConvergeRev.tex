...
\begin{enumerate}
  ...
  \item Did you include the total amount of compute and the type of resources used (e.g., type of GPUs, internal cluster, or cloud provider)?
	...
	different Bayesian optimization algorithms. Compute used in the computation 
	of the Bayesian optimization algorithm itself is irrelevant to the scope of 
	this paper, and identification of convergence requires a negligible amount of compute.
	}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item Did you mention the license of the assets?
    \answerNo{
	The Lockwood code does not have a public license. The Lockwood case study 
