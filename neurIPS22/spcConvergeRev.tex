...
\begin{enumerate}
  ...
  \item Did you include the total amount of compute and the type of resources used (e.g., type of GPUs, internal cluster, or cloud provider)?
	...
	different Bayesian optimization algorithms, but identification of convergence 
	of these various algorithms requires a negligible amount of compute. Compute used in the 
	computation of the Bayesian optimization algorithm itself is irrelevant to the scope of this paper.
	}
\end{enumerate}
...
\begin{enumerate}
  \item If your work uses existing assets, did you cite the creators?
    \answerYes{The Lockwood example is an existing asset and the original author \cite{lockCite} is cited.}
